...
class Hall(models.Model):
    ...
    hall_type = models.CharField(max_length=2, choices=HALL_TYPES)
...
class Show(models.Model):
    ...
    HOUR_CHOICES = [(dt.time(hour=x), f'{y}') for x, y in [
        (9, '9:00 AM'), (12, '12:00 PM'), (15, '3:00 PM')]]
    ...
    def __str__(self):
        return f"[{self.movie}] - [ {self.get_time_display()} | {self.date.strftime('%d %B, %Y')} | {self.hall.hall_type} ]"
